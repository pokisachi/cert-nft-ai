  ...
  return (
    <div className="min-h-[50vh] flex items-center justify-center">
      <div className="w-full max-w-md p-8 bg-white/80 backdrop-blur-xl border border-gray-200/70 rounded-3xl shadow-2xl shadow-black/10 text-center">
        <h2 className="mb-2 text-xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-indigo-700 via-fuchsia-700 to-cyan-700">Có lỗi trong trang</h2>
